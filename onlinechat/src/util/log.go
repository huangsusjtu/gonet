...
func NewLogger(name string) *Logger {
	return &Logger{out: os.Stderr, flag: LstdFlags | Lmicroseconds, name: name}
}

var defaultLogger = NewLogger("onlinechat")

func Debugf(format string, v ...interface{}) {
	defaultLogger.log(LEVEL_DEBUG, format, v...)
}

func Debugln(v ...interface{}) {
	defaultLogger.log(LEVEL_DEBUG, "", v...)
}

func Infof(format string, v ...interface{}) {
	defaultLogger.log(LEVEL_INFO, format, v...)
}

func Infoln(v ...interface{}) {
	defaultLogger.log(LEVEL_INFO, "", v...)
}

func Warnf(format string, v ...interface{}) {

	defaultLogger.log(LEVEL_WARN, format, v...)
}

func Warnln(v ...interface{}) {
	defaultLogger.log(LEVEL_WARN, "", v...)
}

func Errorf(format string, v ...interface{}) {
	defaultLogger.log(LEVEL_ERROR, format, v...)
}

func Errorln(v ...interface{}) {
	defaultLogger.log(LEVEL_ERROR, "", v...)
}

func Fatalf(format string, v ...interface{}) {
	defaultLogger.log(LEVEL_FATAL, format, v...)
}

func Fatalln(v ...interface{}) {
	defaultLogger.log(LEVEL_FATAL, "", v...)
}
